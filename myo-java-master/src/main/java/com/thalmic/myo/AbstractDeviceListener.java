...
public class AbstractDeviceListener implements DeviceListener {
	...
	// When the myo is connected to the computer
	@Override
	public void onConnect(Myo myo, long timestamp, FirmwareVersion firmwareVersion) {
	}

	// When the myo is disconnected from the computer
	@Override
	public void onDisconnect(Myo myo, long timestamp) {
	}

	// When the myo syncs with the arm
	@Override
	public void onArmSync(Myo myo, long timestamp, Arm arm, XDirection xDirection, float rotation, WarmupState warmupState) {
	}

	// When the myo unsyncs from the arm
	@Override
